...
public class doChatRoomController {
    ...
    @GetMapping("/{userUUID}")
    public ResponseEntity<List<ResChatRoomDto>> getChatRoomList(@PathVariable String userUUID){
    ...
    @GetMapping("/{roomId}")
    public ResponseEntity<ResChatRoomDto> getChatRoom(@PathVariable String roomUUID) {
